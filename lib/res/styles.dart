...
class TextStyles {
  ...
  static const TextStyle textSize28 = const TextStyle(
  ...
  static const TextStyle textRed16 = const TextStyle(
    fontSize: Dimens.font_sp16,
    color: Colors.red,
  );
  ...
  static const TextStyle textWhite28 = const TextStyle(
    fontSize: Dimens.font_sp28,
    color: Colors.white,
  );
  static const TextStyle textWhite24 = const TextStyle(
